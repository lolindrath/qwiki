...
Attacklab.wmdBase = function(){
	...
	var imageDirectory = "http://qwiki2.lolindrath.com/images/";
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var setupEditor = function(){
			...
			if (inputBox.form) {
                                // LOLINDRATH: Commented this out - I want Maruku to do
                                // the conversion to Markdown and use Showdown for just
                                // the preview
